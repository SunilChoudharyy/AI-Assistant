    ...
    try:
        while(True):
            ...
            #makig note
                ...
                def create_note(note_title, note_content):
                    try:
                        ...
                        directory_path = "\\OneDrive\\Pictures\\Notes"  # Get the directory path from the user
            ...
            #screeshot
                ...
                path = SR.takeCommand()
                path1name = path + ".png"
                path1 = "OneDrive\\Pictures\\Screenshots\\"+ path1name
                kk = pyautogui.screenshot()
                kk.save(path1)
                os.startfile("OneDrive\\Pictures\\Screenshots")
            ...
            #voice recorder
                ...
                output_file = f"OneDrive\\Pictures\\Audio\\{File_Name}.wav"
                ...
                try:
                    ...
                    os.startfile("OneDrive\\Pictures\\Audio")
                except Exception as e:
            ...
            #weather report
                ...
                output = cv2.VideoWriter(f"OneDrive\\Pictures\\Recording\\{FileName}.avi", fourcc, 20.0, dim)
                ...
                os.startfile("OneDrive\\Pictures\\Recording")
            ...
            #what is the capital
                ...
                for sender, count in counter.items():
                    ...
                    sleep(3)
                    sender_email ="xyz@gmail.com" #SR.takeCommand()
                    SR.speak("Tell Me receiver_email ")
                    sleep(3)
                    receiver_email = "xyz@gmail.com" #SR.takeCommand()
